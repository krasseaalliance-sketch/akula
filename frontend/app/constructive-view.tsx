    ...
    <main className="customer-app cabinet-shell constructive-app">
      ...
      <div className="cabinet-main">
        ...
        <div className="cabinet-wrap">
          <div className="cabinet-page-heading constructive-heading"><div><p className="cabinet-kicker">CONSTRUCTIVE / ASmeT</p><h1>Управление<br />строительством</h1><p>Одна рабочая область: объекты, команда, материалы и подтверждённые строки работ.</p></div><div className="constructive-date"><span className="cabinet-live-dot" /> LIVE<br /><small>{organization.role}</small></div></div>
