...
export default function CustomerPage() {
  ...
  return <main className="customer-app cabinet-shell">
    <aside className="cabinet-sidebar" aria-label="Навигация кабинета">
      <a href={appPath("/")} className="cabinet-brand"><span className="cabinet-brand-mark">S</span><span><strong>SCOUT</strong><small>LEADHUNTER</small></span></a>
      <div className="cabinet-product-label">РАБОЧЕЕ ПРОСТРАНСТВО</div>
      <div className="cabinet-product-switcher"><button className="active" type="button"><span className="cabinet-product-icon scout">S</span><span><strong>Scout</strong><small>Поиск возможностей</small></span></button></div>
      ...
      <div className="cabinet-sidebar-foot"><span className="cabinet-live-dot" /><div><strong>Scout active</strong><small>синхронизация включена</small></div></div>
    </aside>
    <div className="cabinet-main"><header className="cabinet-topbar"><div className="cabinet-top-actions"><span className="cabinet-org">{overview.organization}</span><button className="cabinet-icon-button" type="button" aria-label="Уведомления" onClick={() => setMessage("Новых уведомлений: 3")}>◌<i /></button><a className="cabinet-avatar" href={appPath("/customer")} aria-label="Профиль Scout">S</a></div></header>
